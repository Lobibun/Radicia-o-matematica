...
public class GameController : MonoBehaviour
{
    ...
    private List<List<Question>> todosOsNiveisDePerguntas;
    ...
    public void TentarAvancarDialogo()
{
    ...
    {
        todosOsNiveisDePerguntas = new List<List<Question>>();
        ...
        for (int i = 0; i < 7; i++)
        {
            var nivelAtual = new List<Question>();
            ...
            foreach (var linha in perguntasDoNivel)
            {
                ...
                Question q = new Question { pergunta = campos[0], resposta = int.Parse(campos[1]) };
                nivelAtual.Add(q);
            }
    ...
    void ProximaPergunta()
    {
        ...
        List<Question> poolDePerguntas = todosOsNiveisDePerguntas[nivelPerguntaAtual];
